...
class NetworkOptions():
    def __init__(self):
        ### General ###
        #TO SET
        self.experiment_name = 'superDWI_sdnet_pmcScheme'   # Directory name to be stored in the checkpoint directory. **General**
        self.model_name = 'best_training.pth'  # Working model name - will be stored within the experiment name directory found within the ** General **
        ...
        self.warmup_iter = 4000             # Number of iterations after which the network stops warming up.
        self.batch_size = 256               # Training batch_size.
        
        self.val_freq = 1000                 # How often (iterations) to run the validation loop inside the training loop
        ...
        self.local_rank = 0                         # Set by train.py from LOCAL_RANK env var
        self.device = "cuda:0"                      # Updated per-rank in train.py **General**
        ...
        # Just for inference setting the same as validation
        self.data_dir = '/homes/andrey/E_ResearchData/HCP_New_Download/'
        self.test_subject_list = ['sub-002']

        self.diffusion_dir = 'Diffusion'
        self.shell_number = 3 # 2
        self.data_file = 'data_denoised.nii.gz'
        self.dwi_number = 58 #108
        # self.dwi_folder_name = 'undersampled_fod_b0_18_b1000_90'
        # self.dwi_folder_name = 'undersampled_fod_b0_6_b1000_20_b2000_32' 
        self.dwi_folder_name = 'pmc_scheme' 
